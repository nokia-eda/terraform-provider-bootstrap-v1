...
const (
	create_rs_init = "/apps/bootstrap.eda.nokia.com/v1/namespaces/{namespace}/inits"
	read_rs_init   = "/apps/bootstrap.eda.nokia.com/v1/namespaces/{namespace}/inits/{name}"
	update_rs_init = "/apps/bootstrap.eda.nokia.com/v1/namespaces/{namespace}/inits/{name}"
	delete_rs_init = "/apps/bootstrap.eda.nokia.com/v1/namespaces/{namespace}/inits/{name}"
)
