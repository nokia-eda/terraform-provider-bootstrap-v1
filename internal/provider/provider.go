...
func (p *bootstrapProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewRotateCertificateDataSource,
		NewRotateCertificateListDataSource,
		NewSatelliteDataSource,
		NewSatelliteListDataSource,
