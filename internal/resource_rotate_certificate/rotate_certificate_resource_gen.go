...
package resource_rotate_certificate
...
func RotateCertificateResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^RotateCertificate$"), ""),
				},
				Default: stringdefault.StaticString("RotateCertificate"),
			},
			...
			"name": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
				Description:         "name of the RotateCertificate",
				MarkdownDescription: "name of the RotateCertificate",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"status": schema.SingleNestedAttribute{
				...
				Optional:            true,
				Computed:            true,
				Description:         "RotateCertificateStatus defines the observed state of RotateCertificate",
				MarkdownDescription: "RotateCertificateStatus defines the observed state of RotateCertificate",
			},
		},
	}
}

type RotateCertificateModel struct {
...
func (t SpecType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	skipCertificateValidationAttribute, ok := attributes["skip_certificate_validation"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`skip_certificate_validation is missing from object`)

		return nil, diags
	}

	skipCertificateValidationVal, ok := skipCertificateValidationAttribute.(basetypes.BoolValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`skip_certificate_validation expected to be basetypes.BoolValue, was: %T`, skipCertificateValidationAttribute))
	}
	...
	return SpecValue{
		...
		Nodes:                     nodesVal,
		SkipCertificateValidation: skipCertificateValidationVal,
		state:                     attr.ValueStateKnown,
	}, diags
}
...
type SpecValue struct {
	...
	SkipCertificateValidation basetypes.BoolValue `tfsdk:"skip_certificate_validation"`
	state                     attr.ValueState
}
...
func (v SpecValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["skip_certificate_validation"] = basetypes.BoolType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.SkipCertificateValidation.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["skip_certificate_validation"] = val
...
func (v SpecValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	if diags.HasError() {
		return types.ObjectUnknown(map[string]attr.Type{
			...
			"skip_certificate_validation": basetypes.BoolType{},
		}), diags
	}
	...
	objVal, diags := types.ObjectValue(
		...
		map[string]attr.Value{
			...
			"nodes":                       nodesVal,
			"skip_certificate_validation": v.SkipCertificateValidation,
		})
...
func (v SpecValue) Equal(o attr.Value) bool {
	...
	if !v.SkipCertificateValidation.Equal(other.SkipCertificateValidation) {
		return false
	}
