...
package datasource_rotate_certificate_list
...
func RotateCertificateListDataSourceSchema(ctx context.Context) schema.Schema {
...
type RotateCertificateListModel struct {
