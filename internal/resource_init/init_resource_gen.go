		...
		Attributes: map[string]schema.Attribute{
			...
			"api_version": schema.StringAttribute{
				...
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^bootstrap\\.eda\\.nokia\\.com/v1$"), ""),
				},
				Default: stringdefault.StaticString("bootstrap.eda.nokia.com/v1"),
			},
...
func (t MgmtType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	mgmtInterfaceAttribute, ok := attributes["interface"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`mgmt_interface is missing from object`)

		return nil, diags
	}

	mgmtInterfaceVal, ok := mgmtInterfaceAttribute.(basetypes.ObjectValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`mgmt_interface expected to be basetypes.ObjectValue, was: %T`, mgmtInterfaceAttribute))
	}
	...
	return MgmtValue{
		IpMtu:         ipMtuVal,
		MgmtInterface: mgmtInterfaceVal,
...
type MgmtValue struct {
	...
	MgmtInterface basetypes.ObjectValue `tfsdk:"interface"`
...
func (v MgmtValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["interface"] = basetypes.ObjectType{
		AttrTypes: MgmtInterfaceValue{}.AttributeTypes(ctx),
	}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.MgmtInterface.ToTerraformValue(ctx)
...
func (v MgmtValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	var mgmtInterface basetypes.ObjectValue

	if v.MgmtInterface.IsNull() {
		mgmtInterface = types.ObjectNull(
			MgmtInterfaceValue{}.AttributeTypes(ctx),
		)
	}

	if v.MgmtInterface.IsUnknown() {
		mgmtInterface = types.ObjectUnknown(
			MgmtInterfaceValue{}.AttributeTypes(ctx),
		)
	}

	if !v.MgmtInterface.IsNull() && !v.MgmtInterface.IsUnknown() {
		mgmtInterface = types.ObjectValueMust(
			MgmtInterfaceValue{}.AttributeTypes(ctx),
			v.MgmtInterface.Attributes(),
		)
	}
	...
	attributeTypes := map[string]attr.Type{
		...
		"interface": basetypes.ObjectType{
			AttrTypes: MgmtInterfaceValue{}.AttributeTypes(ctx),
		},
...
func (v MgmtValue) Equal(o attr.Value) bool {
	...
	if !v.MgmtInterface.Equal(other.MgmtInterface) {
		return false
	}
...
var _ basetypes.ObjectTypable = MgmtInterfaceType{}

type MgmtInterfaceType struct {
	basetypes.ObjectType
}

func (t MgmtInterfaceType) Equal(o attr.Type) bool {
	other, ok := o.(MgmtInterfaceType)
...
func (t MgmtInterfaceType) String() string {
	return "MgmtInterfaceType"
}

func (t MgmtInterfaceType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func NewMgmtInterfaceValueNull() MgmtInterfaceValue {
	return MgmtInterfaceValue{
		state: attr.ValueStateNull,
	}
}

func NewMgmtInterfaceValueUnknown() MgmtInterfaceValue {
	return MgmtInterfaceValue{
		state: attr.ValueStateUnknown,
	}
}

func NewMgmtInterfaceValue(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) (MgmtInterfaceValue, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	for name, attributeType := range attributeTypes {
		...
		if !ok {
			diags.AddError(
				"Missing MgmtInterfaceValue Attribute Value",
				"While creating a MgmtInterfaceValue value, a missing attribute value was detected. "+
					"A MgmtInterfaceValue must contain values for all attributes, even if null or unknown. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("MgmtInterfaceValue Attribute Name (%s) Expected Type: %s", name, attributeType.String()),
			)
		...
		if !attributeType.Equal(attribute.Type(ctx)) {
			diags.AddError(
				"Invalid MgmtInterfaceValue Attribute Type",
				"While creating a MgmtInterfaceValue value, an invalid attribute value was detected. "+
					"A MgmtInterfaceValue must use a matching attribute type for the value. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("MgmtInterfaceValue Attribute Name (%s) Expected Type: %s\n", name, attributeType.String())+
					fmt.Sprintf("MgmtInterfaceValue Attribute Name (%s) Given Type: %s", name, attribute.Type(ctx)),
			)
		}
	}
	...
	for name := range attributes {
		...
		if !ok {
			diags.AddError(
				"Extra MgmtInterfaceValue Attribute Value",
				"While creating a MgmtInterfaceValue value, an extra attribute value was detected. "+
					"A MgmtInterfaceValue must not contain values beyond the expected attribute types. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("Extra MgmtInterfaceValue Attribute Name: %s", name),
			)
		}
	}

	if diags.HasError() {
		return NewMgmtInterfaceValueUnknown(), diags
	}
...
func NewMgmtInterfaceValueMust(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) MgmtInterfaceValue {
	object, diags := NewMgmtInterfaceValue(attributeTypes, attributes)
	...
	if diags.HasError() {
		...
		panic("NewMgmtInterfaceValueMust received error(s): " + strings.Join(diagsStrings, "\n"))
	}

	return object
}

func (t MgmtInterfaceType) ValueFromTerraform(ctx context.Context, in tftypes.Value) (attr.Value, error) {
	if in.Type() == nil {
		return NewMgmtInterfaceValueNull(), nil
	}
	...
	if !in.IsKnown() {
		return NewMgmtInterfaceValueUnknown(), nil
	}
	...
	return NewMgmtInterfaceValueMust(MgmtInterfaceValue{}.AttributeTypes(ctx), attributes), nil
}

func (t MgmtInterfaceType) ValueType(ctx context.Context) attr.Value {
	return MgmtInterfaceValue{}
}

var _ basetypes.ObjectValuable = MgmtInterfaceValue{}

type MgmtInterfaceValue struct {
...
func (v MgmtInterfaceValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
...
func (v MgmtInterfaceValue) IsNull() bool {
	return v.state == attr.ValueStateNull
}

func (v MgmtInterfaceValue) IsUnknown() bool {
	return v.state == attr.ValueStateUnknown
}

func (v MgmtInterfaceValue) String() string {
	return "MgmtInterfaceValue"
}

func (v MgmtInterfaceValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (v MgmtInterfaceValue) Equal(o attr.Value) bool {
	other, ok := o.(MgmtInterfaceValue)
...
func (v MgmtInterfaceValue) Type(ctx context.Context) attr.Type {
	return MgmtInterfaceType{
		basetypes.ObjectType{
			AttrTypes: v.AttributeTypes(ctx),
		},
...
func (v MgmtInterfaceValue) AttributeTypes(ctx context.Context) map[string]attr.Type {
	return map[string]attr.Type{
		"interface_selectors": basetypes.ListType{
			ElemType: types.StringType,
		},
