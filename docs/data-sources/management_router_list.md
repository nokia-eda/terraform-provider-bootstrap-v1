...
page_title: "bootstrap-v1_management_router_list Data Source - bootstrap-v1"
subcategory: ""
description: |-
  
---

# bootstrap-v1_management_router_list (Data Source)
...
- `node_selectors` (List of String) Selects TopoNodes on which to configure the management VRF. When left empty, all TopoNodes are selected.
